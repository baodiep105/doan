...
class ChiTietSanPhamController extends Controller
{
    ...
    public function getdata()
    {
        $ds_chi_tiet_san_pham = DB::table('chi_tiet_san_pham')
            ...
            ->orderBy('chi_tiet_san_pham.created_at', 'DESC')
            ->paginate(6);
        $danh_sach_mau = MauSacModel::orderBy('created_at', 'DESC')->get();
        $danh_sach_san_pham = SanPham::where('is_open', 1)->orderBy('created_at', 'DESC')->get();
        $danh_sach_size = sizeModel::orderBy('created_at', 'DESC')->get();
    ...
    public function edit($id)
    {
        ...
        toastr()->error('sủa chi tiết sản phẩm không thành công!');
        return redirect()->back();
    }
    ...
    public function update(editchitietsanphamrequest $request)
    {
        ...
        if (!$chi_tiet_san_pham) {
            ...
            if (empty($exist) || $chi_tiet_san_pham['id'] === $exist['id']) {
