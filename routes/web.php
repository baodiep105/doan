...
Route::middleware('all')->prefix('/admin')->group( function () {
    Route::group(['prefix' => '/danh-muc'], function () {
        ...
        Route::get('/get-data', [DanhMucSanPhamController::class, 'getData']);
        Route::get('/change-status/{id}', [DanhMucSanPhamController::class, 'doiTrangThai']);
    ...
    Route::group(['prefix' => '/san-pham'], function () {
        ...
        Route::get('/load-data', [SanPhamController::class, 'loadData']);
    ...
    Route::group(['prefix' => '/chi-tiet-san-pham'], function () {
        ...
        Route::get('/change-status/{id}', [ChiTietSanPhamController::class, 'changeStatus']);
    ...
    Route::group(['prefix' => '/quan-ly-user'], function () {
        ...
        Route::get('/get-data', [qluserController::class, 'getData']);
        Route::post('/change-status', [qluserController::class, 'changeStatus']);
    ...
    Route::middleware('all')->prefix('/quan-ly-don-hang')->group( function () {
        ...
        Route::put('/change-status/{id}', [DonHangController::class, 'changeStatus']);
    ...
    Route::middleware('admin')->prefix('/quan-ly-nhan-vien')->group( function () {
        ...
        Route::get('/get-data', [NhanVienController::class, 'getData']);
    ...
    Route::group(['prefix' => '/quan-ly-anh'], function () {
        ...
        Route::get('/get-data', [qlanhController::class, 'getData']);
    ...
    Route::group(['prefix' => '/quan-ly-banner'], function () {
        ...
        Route::get('/get-data', [BannerController::class, 'getData']);
        Route::get('/change-status/{id}', [BannerController::class, 'doiTrangThai']);
    ...
    Route::group(['prefix' => '/quan-ly-khuyen-mai'], function () {
        ...
        Route::get('/get-data', [KhuyenMaiController::class, 'getData']);
        Route::get('/change-status/{id}', [KhuyenMaiController::class, 'doiTrangThai']);
    ...
    Route::group(['prefix' => '/quan-ly-size'], function () {
        ...
        Route::get('/get-data', [sizeController::class, 'getData']);
    ...
    Route::group(['prefix' => '/quan-ly-mau'], function () {
        ...
        Route::get('/get-data', [mauController::class, 'getData']);
